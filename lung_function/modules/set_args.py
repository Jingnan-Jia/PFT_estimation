...
def get_args(jupyter=False):
    ...
    parser.add_argument(
        '--PNB', help='points number for each image', type=int, default=14000)
    parser.add_argument(
    ...
    parser.add_argument('--input_mode', help='what to input', choices=('ct', 'ct_left', 'ct_right','ct_left_in_lung', 'ct_right_in_lung','ct_upper','ct_lower', 'ct_front', 'ct_back','ct_upper_in_lung','ct_lower_in_lung', 'ct_front_in_lung', 'ct_back_in_lung', 'vessel', 'ct_masked_by_vessel', 'vessel_skeleton_pcd', 'ct_masked_by_vessel_dilated1',
