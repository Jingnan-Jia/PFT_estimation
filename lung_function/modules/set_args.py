...
def get_args(jupyter=False):
    ...
    parser.add_argument('--input_mode', help='what to input', choices=('ct', 'ct_left', 'ct_right','ct_upper','ct_lower', 'ct_front', 'ct_back','ct_upper_in_lung','ct_lower_in_lung', 'ct_front_in_lung', 'ct_back_in_lung', 'vessel', 'ct_masked_by_vessel', 'vessel_skeleton_pcd', 'ct_masked_by_vessel_dilated1',
